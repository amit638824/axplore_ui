...
new Selectr("#default"),
new Selectr("#division"),
new Selectr("#subdivision"),
new Selectr("#fromSelectCity")
new Selectr("#toCity")
new Selectr("#fromSelectCity1")
new Selectr("#fromSelectCity2")
new Selectr("#fromSelectCity3")
new Selectr("#toCity1")
new Selectr("#toCity2")
new Selectr("#toCity3")
new Selectr("#costsheeHead"),
new Selectr("#costsheeParticulars"),
new Selectr("#costsheetCurrency"),
new Selectr("#costsheeHead1"),
new Selectr("#costsheeParticulars1"),
new Selectr("#costsheetCurrency1")
new Selectr("#costsheeHead2"),
new Selectr("#costsheeParticulars2"),
new Selectr("#costsheetCurrency2")
new Selectr("#costsheeHead3"),
new Selectr("#costsheeParticulars3"),
new Selectr("#costsheetCurrency3")
